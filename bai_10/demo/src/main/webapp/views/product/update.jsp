...
<div class="container mt-4">
    ...
    <form action="/products?action=edit" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="quantity" class="form-control" value="${product.mo_ta}" required>
        </div>

        <div class="mb-3">
            <label class="form-label">Hãng sản xuất</label>
            <input type="number" name="quantity" class="form-control" value="${product.hang_san_xuat}" required>
        </div>
